...
public class XmlObjectMapper {
    ...
    public static Doctor toDoctor(DoctorXml doctorXml) {
    ...
    public static Specialty toSpecialty(SpecialtyXml specialtyXml) {
        Specialty specialty = new Specialty();
        specialty.setId(specialty.getId());
        specialty.setName(specialtyXml.getName());
        return specialty;
    }

    public static Service toService(ServiceXml serviceXml) {
    ...
    public static Patient toPatient(PatientXml patientXml) {
