 ...
 *       &lt;sequence&gt;
 *         &lt;element name="service" type="{urn:ns}service" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ServicesXml {
    ...
    protected List<ServiceXml> service;
     ...
     * 
     */
    public List<ServiceXml> getService() {
        if (service == null) {
            service = new ArrayList<ServiceXml>();
        }
        return this.service;
    }
